...
function mospace_theme_preprocess_html(&$variables) {
  ...
  // Add UMSystem external stylesheet
  drupal_add_css('http://www.umsystem.edu/css/umsbar.css', array('type' => 'external'));
  drupal_add_css('https://www.umsystem.edu/css/umsbar.css', array('type' => 'external'));
...
function mospace_theme_preprocess_maintenance_page(&$variables) {
  ...
  drupal_add_css(drupal_get_path('theme', 'lso-theme') . '/css/maintenance-page.css');
}
